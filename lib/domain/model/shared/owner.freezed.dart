...
class _$_Owner implements _Owner {
  _$_Owner({required this.id, required this.name, required this.avatarUrl});
  ...
  @override
  String toString() {
    return 'Owner(id: $id, name: $name, avatarUrl: $avatarUrl)';
  }
...
abstract class _Owner implements Owner {
  factory _Owner(
      ...
      required final String avatarUrl}) = _$_Owner;
